...
class CustomSwipeDetector extends StatefulWidget {
  ...
  /// Creates a [CustomSwipeDetector] widget.
...
class _SimpleGestureDetectorState extends State<CustomSwipeDetector> {
